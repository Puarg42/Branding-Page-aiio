...
export const metadata = createMetadata({
  path: "/",
  title: "aiio | Organizational Intelligence with System",
    ...
    <section className="hero" id="home-hero">
      <div className="landing-hero-content">
        ...
        <EditorialCTAGroup className="actions hero-actions" ariaLabel="Primary actions">
          ...
          <Link className="button hero-button secondary" href="/live-demo/kontakt">
    ...
    <main className="home-page">
      ...
      <div className="home-page-story">
        ...
        <ExecutiveCTA
          ...
          copy="Explore where Organizational Intelligence can create value in your organization and what the first credible next step should be."
